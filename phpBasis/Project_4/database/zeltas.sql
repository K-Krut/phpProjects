...
INSERT INTO `metal` (`metal_id`, `metal_name`) VALUES
(1, 'Bronze'),
(2, 'Silver'),
(3, 'Pewter'),
(4, 'Golden silver'),
...
INSERT INTO `product` (`product_id`, `product_code`, `product_name`, `product_size`, `product_weight`, `product_price_uah`, `product_price_usd`, `category_id`, `metal_id`, `main_photo_id`) VALUES
...
INSERT INTO `product_photo` (`photo_id`, `photo`, `product_id`) VALUES
...
INSERT INTO `users` (`id`, `email`, `password`, `firstname`, `lastname`, `address`, `mobile`, `created_on`) VALUES
